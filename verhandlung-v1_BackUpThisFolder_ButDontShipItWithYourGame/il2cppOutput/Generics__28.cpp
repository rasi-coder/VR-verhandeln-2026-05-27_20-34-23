...
IL_0009:
	{
		RuntimeObject* L_1 = ___1_value;
		ThrowHelper_IfNullAndNullsAreIllegalThenThrow_TisSystemCapabilityInfo_t59FE1EA1766D73169E18E052FFEADAFD9A46B4E4_mB995B5E4D03EABD7649A80648141F7336A565218(L_1, (int32_t)((int32_t)15), il2cpp_rgctx_method(method->klass->rgctx_data, 58));
	}
	try
	{
		{
		...
		try
		{
			int32_t L_3 = V_0;
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_set_Item_m74A65133476F2EC8DA764705A4ACE777D05EF7F9(__this, L_3, ((*(SystemCapabilityInfo_t59FE1EA1766D73169E18E052FFEADAFD9A46B4E4*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 15)))), il2cpp_rgctx_method(method->klass->rgctx_data, 59));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
